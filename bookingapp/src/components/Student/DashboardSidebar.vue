  ...
  >
    <div v-show="sidebarOpen" class="flex flex-col h-full overflow-y-auto">
      ...
      >
        ...
        <span class="text-sm tracking-wide ml-4 whitespace-nowrap">Ground Ops (DCS)</span>
      </router-link>
      ...
      >
        ...
        <span class="text-sm tracking-wide ml-4 whitespace-nowrap">Performance Records</span>
      </router-link>
