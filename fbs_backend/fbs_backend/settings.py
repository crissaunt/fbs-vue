...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,192.168.1.10,fbs-vue.onrender.com,.onrender.com,fbs-lms.netlify.app').split(',')

CORS_ALLOW_ALL_ORIGINS = config('CORS_ALLOW_ALL_ORIGINS', default=DEBUG, cast=bool)
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://localhost:5173,http://192.168.1.10:5173,https://fbs-vue-1.onrender.com,https://fbs-vue.onrender.com,https://fbs-lms.netlify.app').split(',')
...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='http://localhost:5173,http://192.168.1.10:5173,https://fbs-vue-1.onrender.com,https://fbs-vue.onrender.com,https://fbs-lms.netlify.app').split(',')
...
WEBSITE_URL = config('WEBSITE_URL', default='https://fbs-lms.netlify.app')
FRONTEND_URL = config('FRONTEND_URL', default='https://fbs-lms.netlify.app')
